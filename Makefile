...
STRING_FUNCS = ft_strlen.c ft_strchr.c ft_toupper.c ft_tolower.c ft_strlcpy.c ft_strlcat.c ft_strrchr.c ft_strncmp.c ft_strnstr.c ft_substr.c ft_strdup.c ft_strjoin.c ft_strtrim.c ft_split.c ft_itoa.c
